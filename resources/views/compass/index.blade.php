            ...
            <div id="resources" class="tab-pane fade in @if(empty($active_tab) || (isset($active_tab) && $active_tab == 'resources')){!! 'active' !!}@endif">
                ...
                <div class="collapsible">
                    ...
                    <div class="collapse-content collapse in" id="links">
                        <div class="row">
                            <div class="col-md-4">
                                <a href="https://laravelvoyager.com/docs" target="_blank" class="voyager-link" style="background-image:url('/vendor/sertxudeveloper/voyager/assets/images/compass/documentation.jpg')">
                                    <span class="resource_label"><i class="voyager-documentation"></i> <span class="copy">Documentation</span></span>
                                </a>
                            </div>
                            <div class="col-md-4">
                                <a href="https://laravelvoyager.com" target="_blank" class="voyager-link" style="background-image:url('/vendor/sertxudeveloper/voyager/assets/images/compass/voyager-home.jpg')">
                                    <span class="resource_label"><i class="voyager-browser"></i> <span class="copy">Voyager Homepage</span></span>
                                </a>
                            </div>
                            <div class="col-md-4">
                                <a href="https://larapack.io" target="_blank" class="voyager-link" style="background-image:url('/vendor/sertxudeveloper/voyager/assets/images/compass/hooks.jpg')">
